      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-800">Sobre Nós</h3>
            <p className="text-gray-600">
              Somos uma loja especializada em camisetas de alta qualidade, com designs exclusivos e materiais premium.
            </p>
          </div>
          ...
          {/* Atendimento */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-800">Atendimento</h3>
            <ul className="space-y-2">
              <li className="text-gray-600">
                <span className="font-medium">Email:</span> contato@teste.com.br
              </li>
              <li className="text-gray-600">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} teste. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
